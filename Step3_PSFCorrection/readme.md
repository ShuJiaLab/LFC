...
> **Note 2** The filename should be in a format of [Latin letters]+[arabic numbders]+[suffix]. The [arabic numbers] should be centered at "50000" (this matches the data acquired by MCL objective lens positioner).
