...
if mode == "hybrid"
    ...
    projfunc2 = @BackForewardProj_waveopt;
...
elseif mode == "fast"
    ...
    projfunc2 = @BackForewardProj_waveopt_fast;
    extravar = varargin{1}.INVOTF;
end
...
for ii = 2:maxIter
    tic;
    [Xguess,Project_Error] = projfunc2(OTF,Xguess,FLFimg,Project_Error,varargin{1}.INVOTF);
    time_sum = time_sum + toc;
end
